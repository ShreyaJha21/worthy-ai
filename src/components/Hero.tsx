...
const StatBox = ({ icon: Icon, value, label }: { icon: any; value: string; label: string }) => (
  <div className="group relative">
    ...
    <div className="relative bg-white/10 backdrop-blur-sm rounded-2xl p-8 border border-white/20 transform transition-all duration-300 group-hover:scale-105 group-hover:border-white/30">
      ...
      <div className="container mx-auto px-4 relative">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6 leading-tight">
            Know Your <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-200 via-purple-200 to-pink-200">True Worth</span> in the Job Market
          </h1>

          {/* Subheading */}
          <p className="text-xl text-white/80 mb-8 max-w-2xl mx-auto">
            Make data-driven decisions about your career. Get real-time market insights, 
            salary benchmarks, and expert guidance to maximize your earning potential.
          </p>
