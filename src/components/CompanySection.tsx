...
import { Upload, Github, Linkedin, Building2, FileText, Users } from 'lucide-react';
    ...
    >
      ...
      <div className="p-6 md:p-8 relative">
        <div className="flex items-center gap-3 mb-6">
          ...
          <div>
            <h3 className="text-2xl font-bold text-slate-800 dark:text-white">For Companies</h3>
        ...
        <AnimatePresence mode="wait">
          {!showResults ? (
            ...
            >
              ...
              <Button type="submit" variant="primary" size="lg" className="w-full bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600">
                Analyze Candidate
              </Button>
            </motion.form>
          ) : (
            ...
            >
              <div className="bg-gradient-to-br from-purple-50 to-pink-50 dark:from-purple-900/20 dark:to-pink-900/20 p-6 rounded-xl">
                <h4 className="text-sm font-medium text-slate-500 dark:text-slate-400 mb-1">Skills & Technologies</h4>
              ...
              <div className="bg-white dark:bg-slate-700 p-6 rounded-xl border border-slate-200 dark:border-slate-600">
                <h4 className="text-sm font-medium text-slate-500 dark:text-slate-400 mb-1">Suggested Salary Range</h4>
                <p className="text-2xl font-bold text-slate-800 dark:text-white">$115,000 - $140,000</p>
                <p className="text-sm text-slate-600 dark:text-slate-400 mt-1">Based on 5+ years of experience and skill set</p>
              </div>
              ...
              <div className="bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 p-6 rounded-xl flex items-center">
                ...
                <div>
                  <h4 className="font-bold text-blue-800 dark:text-blue-400">Strong Candidate</h4>
              ...
              <div className="bg-white dark:bg-slate-700 p-6 rounded-xl border border-slate-200 dark:border-slate-600">
                <h4 className="text-sm font-medium text-slate-500 dark:text-slate-400 mb-3">Strengths</h4>
